...
import br.com.claudio.drogaria.dao.CaixaDAO;
...
public class CaixaBean {
	...
	public void salvar(){
		// instanciando um Calendar para poder somar mais 1 dia a data de abertura
		//pois o componente pega um dia antes do selecionado
